...
public enum OfxCurrencyEnum
{
    // <xsd:simpleType name="CurrencyEnum">
    //     <xsd:annotation>
    //         <xsd:documentation>
    //               These values are based on the ISO-4217 three-letter currency identifiers.        The OFX element "CURRENCYENUM" is of type "CurrencyEnum".
    //         </xsd:documentation>
    //     </xsd:annotation>
